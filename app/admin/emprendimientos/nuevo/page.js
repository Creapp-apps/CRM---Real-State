...
export default function AdminEmprendimientoForm() {
  const router = useRouter();

  const handleSubmit = (e) => {
    e.preventDefault();
    // Frontend-only — backend will handle persistence
  ...
  return (
    <>
      <div className={styles.pageHeader}>
        <div>
          <h2 className={styles.pageTitle}>Nuevo Emprendimiento</h2>
          <p className={styles.pageSubtitle}>Completá los datos del proyecto</p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem' }}>
        <div className={styles.card}>
          ...
          <div className={styles.formGroup}>
            ...
            <input className={styles.formInput} placeholder="Ej: River Park Towers" />
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Ubicación</label>
              <input className={styles.formInput} placeholder="Barrio / Ciudad" />
            </div>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Dirección</label>
              <input className={styles.formInput} placeholder="Dirección completa" />
            </div>
          </div>
          <div className={styles.formGroup}>
            <label className={styles.formLabel}>Descripción</label>
            <textarea className={styles.formTextarea} placeholder="Descripción detallada del emprendimiento..." rows={5} />
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem' }}>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Unidades totales</label>
              <input className={styles.formInput} type="number" placeholder="120" />
            </div>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Precio desde</label>
              <input className={styles.formInput} placeholder="USD 100.000" />
            </div>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Avance de obra (%)</label>
              <input className={styles.formInput} type="number" placeholder="75" min={0} max={100} />
            </div>
          </div>
          <div className={styles.formGroup}>
            <label className={styles.formLabel}>Amenities</label>
            <input className={styles.formInput} placeholder="Pileta, SUM, Gym, Seguridad 24hs..." />
          </div>
        </div>
        ...
        <div>
          ...
          <div className={styles.card}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.7rem', marginTop: '0.25rem' }}>o hacé click para seleccionar</div>
            </div>
          </div>
        </div>
      </div>
